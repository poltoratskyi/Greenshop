...
export const svgBurgerMenu = (
  <svg width="30" height="30" viewBox="0 0 24 24">
    <path strokeWidth="1.5" d="M3 5h18v1H3zm0 8h18v-1H3zm0 7h18v-1H3z" />
    <path strokeWidth="1.5" fill="none" d="M0 0h24v24H0z" />
  </svg>
);
...
export const links = [
  { svg: delivery, menu: "Delivery", href: "#" },
  { svg: map, menu: "Map", href: "#" },
  { svg: contacts, menu: "Contact", href: "#" },
  { svg: returns, menu: "Returns", href: "#" },
  { svg: payments, menu: "Payments", href: "#" },
];
